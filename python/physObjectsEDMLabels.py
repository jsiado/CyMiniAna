...
largeRJetLabels = cms.PSet(
    ...
    ljetGenJetPtLabel        = cms.InputTag("jetsAK8"+jetType, "jetAK8"+jetType+"GenJetPt"),
    ljetGenJetEtaLabel       = cms.InputTag("jetsAK8"+jetType, "jetAK8"+jetType+"GenJetEta"),
    ljetGenJetPhiLabel       = cms.InputTag("jetsAK8"+jetType, "jetAK8"+jetType+"GenJetPhi"),
    ljetGenJetELabel         = cms.InputTag("jetsAK8"+jetType, "jetAK8"+jetType+"GenJetE"),
    ljetGenJetChargeLabel    = cms.InputTag("jetsAK8"+jetType, "jetAK8"+jetType+"GenJetCharge"),
    ...
    ljet_subjetGenJetPtLabel        = cms.InputTag("subjetsAK8"+jetType, "subjetAK8"+jetType+"GenJetPt"),
    ljet_subjetGenJetEtaLabel       = cms.InputTag("subjetsAK8"+jetType, "subjetAK8"+jetType+"GenJetEta"),
    ljet_subjetGenJetPhiLabel       = cms.InputTag("subjetsAK8"+jetType, "subjetAK8"+jetType+"GenJetPhi"),
    ljet_subjetGenJetELabel         = cms.InputTag("subjetsAK8"+jetType, "subjetAK8"+jetType+"GenJetE"),
    ljet_subjetGenJetChargeLabel    = cms.InputTag("subjetsAK8"+jetType, "subjetAK8"+jetType+"GenJetCharge"),
)
